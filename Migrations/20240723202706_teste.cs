    ...
    public partial class teste : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_IngredientesRango", x => new { x.IngredientesId, x.RangosId });
                    table.ForeignKey(
                        name: "FK_IngredientesRango_Ingredientes_IngredientesId",
                        column: x => x.IngredientesId,
                        principalTable: "Ingredientes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_IngredientesRango_Rangos_RangosId",
                        column: x => x.RangosId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_IngredientesRango_RangosId",
                table: "IngredientesRango",
                column: "RangosId");
        }
